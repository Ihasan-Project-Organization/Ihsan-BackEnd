            ...
            <div class="relative z-10 flex flex-col gap-6 sm:flex-row sm:items-center sm:justify-between">
                <div class="max-w-2xl">
                    ...
                    <p class="mt-3 leading-8 text-[#dfe6d5]">
                        أهلًا بك في منصة إحسان. يمكنك إدارة طلباتك ومتابعة المساعدات بسهولة.
                    </p>
        ...
        <div class="mt-7 grid gap-7 lg:grid-cols-[1.35fr_.65fr]">
            <section class="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm sm:p-8">
                ...
                <dl class="mt-6 grid gap-4 sm:grid-cols-2">
                    ...
                    <div class="rounded-xl bg-slate-50 p-4">
                        ...
                        <dd class="mt-1 font-bold text-slate-800">{{ $elderProfile?->phone_number ?? 'غير مضاف' }}</dd>
                    </div>
                    <div class="rounded-xl bg-slate-50 p-4">
                        <dt class="text-xs font-bold text-slate-400">المدينة</dt>
                        <dd class="mt-1 font-bold text-slate-800">{{ $elderProfile?->city ?? 'غير محددة' }}</dd>
                    </div>
                    <div class="rounded-xl bg-slate-50 p-4">
                        <dt class="text-xs font-bold text-slate-400">حالة الحساب</dt>
                        <dd class="mt-1 font-bold text-emerald-700">نشط ومفعّل</dd>
                    </div>
                </dl>
            </section>
            ...
            <aside class="rounded-2xl bg-[#eef2e8] p-6 sm:p-8">
                ...
                <p class="mt-3 text-sm leading-7 text-slate-600">
                    هل تحتاج مساعدة في شراء أدوية أو مرافقة طبية أو زيارة ودية؟ فريق المتطوعين جاهز لخدمتك.
                </p>
