            ...
            <div class="grid gap-5 p-5 sm:p-8 md:grid-cols-2 lg:p-12">
                <a href="{{ route('frontend.elderly.register') }}"
                    ...
                    <img src="{{ asset('assets/img/oldage.jpeg') }}" alt="تسجيل كبير السن"
                        class="hidden h-52 w-full object-cover sm:block">
                    <div class="p-6 text-center">
                        ...
                        <p class="mt-2 text-sm leading-7 text-slate-500">أنشئ حسابًا لطلب الخدمات والمساعدة من
                            المتطوعين.</p>
                        <span
                            class="mt-5 inline-flex rounded-xl bg-[#31421e] px-6 py-3 font-bold text-white transition group-hover:bg-[#52643a]">بدء
                            التسجيل</span>
                    </div>
                </a>
